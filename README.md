# Corso Python Base - B22-432 (2025)

Corso introduttivo alla programmazione con Python.

## Struttura del repository

- **Lezioni/** — Codice e materiale visto durante le lezioni
- **Esercizi/** — Esercizi assegnati
- **Soluzioni/** — Soluzioni degli esercizi

## Materiale extra

Risorse aggiuntive disponibili sul sito del docente:
